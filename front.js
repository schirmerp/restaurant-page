...
export function frontPage (){
    ...
    elementA.innerHTML = 'a wonderful place to grab a byte. dont miss the spaghetti 0s. blah blah blah blahdibbyd da da. Joes was started in 2021. shortly after covid was offically canceled by those elibiable to cancel(individuals known as: "insert chosen pronoun here"). It was meant to be a place simply to attain qualifications for government handouts. then one day joes famous ramen recipe was released via hacker document dumps and the rest is history'; 
